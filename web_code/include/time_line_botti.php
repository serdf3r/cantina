        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#pannello-<?php echo $row['ID']; ?>"><?php echo $row['SIGLA']; ?></a>
                </h4>
            </div>
                ...
                <div class="panel-body">
                    <div style="display:inline-block;width:100%;overflow-y:auto;">
                        <ul class="timeline timeline-horizontal">
                            <?php
                            // --- Start Botte ---
                            $data_prec = $row["DATA_RIEMPIMENTO"];
                            ?>
                            <li class="timeline-item imbottigliamento">
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h3 class="timeline-title"><?php echo $row["SIGLA"]; ?>
                                        </h3>
                                        <p>
                                            <small class="text-muted"><i class="glyphicon glyphicon-time"></i>
                                                 Capacità: <?php echo $row["CAPACITA"]; ?>
                                            </small>
                                        </p>
                                    </div>
