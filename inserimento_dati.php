                ...
                <div class="panel-body">
                    <form action="#" method="post" id="inserimento_vendemmia">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <input type="text" class="form-control datepicker" data-date-format="mm/dd/yyyy" id="vendemmia_data" name="vendemmia_data" value="<?php if (isset($row_{'vendemmie'}['DATA'])){echo $row_{'vendemmie'}['DATA']; }?>">
                            </div>

                            <label for="vendemmia_costo" class="col-sm-1 control-label">Costo</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control"  id="vendemmia_costo" name="vendemmia_costo" value="<?php if (isset($row_{'vendemmie'}['COSTO'])){echo $row_{'vendemmie'}['COSTO']; }?>" placeholder="Quanto abbiamo speso">
                            </div>
                            <label for="vendemmia_luogo" class="col-sm-1 control-label">Luogo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="vendemmia_luogo" name="vendemmia_luogo" value="<?php if (isset($row_{'vendemmie'}['LUOGO'])){echo $row_{'vendemmie'}['LUOGO']; }?>" placeholder="Dove è stata fatta">
                            </div>
                            <label for="vendemmia_dettagli" class="col-sm-1 control-label">Dettagli</label>
                            <div class="col-sm-5">
                                <textarea class="form-control"  id="vendemmia_dettagli" name="vendemmia_dettagli" ><?php if (isset($row_{'vendemmie'}['DETTAGLI'])){echo $row_{'vendemmie'}['DETTAGLI']; }?></textarea>
                            </div>
                            <label for="vendemmia_note" class="col-sm-1 control-label">Note</label>
                            <div class="col-sm-5">
                                <textarea class="form-control"  id="vendemmia_note" name="vendemmia_note" ><?php if (isset($row_{'vendemmie'}['NOTE'])){echo $row_{'vendemmie'}['NOTE']; }?></textarea>
                            </div>
                            <div class="col-sm-12"><button class="btn btn-primary" type="submit">Inserisci Vendemmia</button></div>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="panel-body">
                    <form action="#" method="post" id="inserimento_vino">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <input type="text" class="form-control datepicker" data-date-format="mm/dd/yyyy" id="vino_data" name="vino_data" placeholder=""  value="<?php if (isset($row_{'vini'}['DATA_IMBOTTIGLIAMENTO'])){echo $row_{'vini'}['DATA_IMBOTTIGLIAMENTO']; }?>">
                            </div>
                            <label for="vino_nome" class="col-sm-1 control-label">Nome</label>
                            <div class="col-sm-4">
                                <input type="text" class="form-control"  id="vino_nome" name="vino_nome" placeholder="Il nome del vino" value="<?php if (isset($row_{'vini'}['NOME'])){echo $row_{'vini'}['NOME']; }?>">
                            </div>   
                            ...
                            <div class="col-sm-3">
                                <select name="vino_vendemmia">
                                    ...
                                    while ($row_vendemmie = mysqli_fetch_array($result_vendemmie)) {
                                       ...
                                       if (isset($row_{'vini'}['ID_VENDEMMIE'])){if ($row_{'vini'}['ID_VENDEMMIE'] == $row_vendemmie['ID']){
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control"  id="vino_note" name="vino_note" > <?php if (isset($row_{'vini'}['NOTE'])){echo $row_{'vini'}['NOTE']; }?></textarea>
                            </div>
                ...
                <div class="panel-body">
                    <form action="#" method="post" id="inserimento_analisi">
                        <div class="row">
                            ...
                            <div class="col-sm-1">
                                <input type="text" class="form-control datepicker" data-date-format="mm/dd/yyyy" id="analisi_data" name="analisi_data" placeholder="">
                            </div>
                            ...
                            <div class="col-sm-4">
                                <select name="analisi_laboratorio">
                                    ...
                                    while ($row_laboratori = mysqli_fetch_array($result_laboratori)) {
                                        echo "<option value='" . $row_laboratori['ID'] . "'>" . $row_laboratori['NOME'] . "</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_tav" name="analisi_tav" placeholder="valore">
                            </div>
                            <label for="analisi_tav_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_tav_um" name="analisi_tav_um">
                            </div>
                            <label for="analisi_tav_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_tav_met" name="analisi_tav_met">
                            </div>

                            <label for="analisi_at" class="col-sm-2 control-label">Acidità Totale</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_at" name="analisi_at" placeholder="valore">
                            </div>
                            <label for="analisi_at_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_at_um" name="analisi_at_um">
                            </div>
                            <label for="analisi_at_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_at_met" name="analisi_at_met">
                            </div>

                            <label for="analisi_av" class="col-sm-2 control-label">Acidità Volatile</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_av" name="analisi_av" placeholder="valore">
                            </div>
                            <label for="analisi_av_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_av_um" name="analisi_av_um">
                            </div>
                            <label for="analisi_av_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_av_met" name="analisi_av_met">
                            </div>

                            <label for="analisi_ast" class="col-sm-2 control-label">Anidiride Solforosa Totale</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_ast" name="analisi_ast" placeholder="valore">
                            </div>
                            <label for="analisi_ast_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_ast_um" name="analisi_ast_um">
                            </div>
                            <label for="analisi_ast_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_ast_met" name="analisi_ast_met">
                            </div>

                            <label for="analisi_alm" class="col-sm-2 control-label">Acido L Malico</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_alm" name="analisi_alm" placeholder="valore">
                            </div>
                            <label for="analisi_alm_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_alm_um" name="analisi_alm_um">
                            </div>
                            <label for="analisi_alm_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_alm_met" name="analisi_alm_met">
                            </div>

                            <label for="analisi_all" class="col-sm-2 control-label">Acido L Lattico</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_all" name="analisi_all" placeholder="valore">
                            </div>
                            <label for="analisi_all_um" class="col-sm-1 control-label">Unità di misura</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_all_um" name="analisi_all_um">
                            </div>
                            <label for="analisi_all_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_all_met" name="analisi_all_met">
                            </div>

                            <label for="analisi_ph" class="col-sm-2 control-label">PH</label>
                            <div class="col-sm-1">
                                <input type="text" class="form-control"  id="analisi_ph" name="analisi_ph" placeholder="valore">
                            </div>        
                            <div class="col-sm-2"></div>
                            <label for="analisi_ph_met" class="col-sm-2 control-label">Metodo</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="analisi_ph_met" name="analisi_ph_met">
                            </div>

                            <label for="analisi_trat_cons" class="col-sm-1 control-label">Trattamento Consigliato</label>
                            <div class="col-sm-5">
                                <textarea class="form-control"  id="analisi_trat_cons" name="analisi_trat_cons" ></textarea>
                            </div>
                            <label for="analisi_note" class="col-sm-1 control-label">Note</label>
                            <div class="col-sm-5">
                                <textarea class="form-control"  id="analisi_note" name="analisi_note" ></textarea>
                            </div>
                ...
                <div class="panel-body">
                    <form action="#" method="post" id="inserimento_laboratorio">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="laboratorio_nome" name="laboratorio_nome" placeholder=""  value="<?php if (isset($row_{'laboratori'}['NOME'])){echo $row_{'laboratori'}['NOME']; }?>">
                            </div>
                            <label for="laboratorio_email" class="col-sm-1 control-label">E-mail</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control"  id="laboratorio_email" name="laboratorio_email" placeholder="Email principale del laboratorio" value="<?php if (isset($row_{'laboratori'}['EMAIL'])){echo $row_{'laboratori'}['EMAIL']; }?>">
                            </div>
                            <label for="laboratorio_note" class="col-sm-1 control-label">Note</label>
                            <div class="col-sm-5">
                                <textarea class="form-control"  id="laboratorio_note" name="laboratorio_note" ><?php if (isset($row_{'laboratori'}['NOTE'])){echo $row_{'laboratori'}['NOTE']; }?></textarea>
                            </div>
